  ...
  <section>
    <el-col :span="24" class="content-header">
      ...
      <div class="header-bot">
        ...
        <div class="item">
          <label for style="width:100px">原保管期限：</label>
    ...
    <el-col :span="24" style="background-color:#fff;margin-top:20px;min-height:500px;">
      ...
      <div style="padding:0 15px 100px 15px;" ref="tableBox">
        ...
        >
          ...
          <el-table-column label="档案员鉴定意见" align="center" prop="opinion"></el-table-column>
          <el-table-column label="小组鉴定意见" align="center">
            <template slot-scope="scope">
              <span>{{getYj(scope.row.status)}}</span>
            </template>
          </el-table-column>
    ...
    handleRead(row) {
      ...
      this.$router.push({
        ...
        query:{
          ...
          title:Base64.encode("查看"),
          audit:Base64.encode(true)
        }
      });
    },
